...
#ifdef HD_BRONZE  // for Bronze/Ag/Pl
const uint16_t PROGMEM F_ESC_combo[] = {KC_J, KC_B, COMBO_END}; // ESCape
const uint16_t PROGMEM Hndsh_combo[] = {KC_X, KC_G, COMBO_END}; // – n dash
const uint16_t PROGMEM Hmdsh_combo[] = {KC_X, KC_M, COMBO_END}; // — m dash
const uint16_t PROGMEM Htild_combo[] = {KC_J, KC_P, COMBO_END}; // ~ tilde (not the dead one)
const uint16_t PROGMEM Hunds_combo[] = {KC_O, KC_Y, COMBO_END}; // _ underscore
const uint16_t PROGMEM Hequal_combo[] = {KC_W, KC_Y, COMBO_END}; // = equal
#else  // for Neu/Au/Ti/Rh
...
//const uint16_t PROGMEM Helip_combo[] = {KC_DOT, KC_QUOT, COMBO_END}; // … elipses
#else // for Neu/Au/Ti
...
#ifdef HD_BRONZE  // for Bronze/Ag/Pl
const uint16_t PROGMEM Hgrv_combo[] = {RGUI_T(KC_E), RALT_T(KC_C), COMBO_END}; // ` grave (dead key)
const uint16_t PROGMEM Hcirc_combo[] = {RSFT_T(KC_A), RALT_T(KC_C), COMBO_END}; // ˆ circumflex (dead key)
const uint16_t PROGMEM Hmacr_combo[] = {KC_O, KC_Y, COMBO_END}; // - macron (dead key)
const uint16_t PROGMEM Hring_combo[] = {RSFT_T(KC_A), RCTL_T(KC_I), COMBO_END}; // ˚ ring (dead key)
const uint16_t PROGMEM Hcedi_combo[] = {LT(L_FN_NUM, KC_COMM), RALT_T(KC_C), COMBO_END}; // ¸ cedille (dead key)
#else // for Neu/Au/Ti/Rh
...
const uint16_t PROGMEM Hae_combo[] = {LT(L_FN_NUM, KC_COMM), RGUI_T(KC_E), COMBO_END}; //
const uint16_t PROGMEM Hoslsh_combo[] = {KC_O, KC_W, COMBO_END}; // ø/Ø
#endif
...
const uint16_t PROGMEM H_Wh_combo[] = {KC_W, KC_O, COMBO_END}; // TYPE "wh"
const uint16_t PROGMEM H_Ch_combo[] = {RALT_T(KC_C), RGUI_T(KC_A), COMBO_END}; // TYPE "ch"
...
const uint16_t PROGMEM H_Sch_combo[] = {LCTL_T(KC_C), LALT_T(KC_S), LGUI_T(KC_N), COMBO_END}; // TYPE "sch"
#endif
...
const uint16_t PROGMEM H_there_combo[] = {LSFT_T(KC_T), LT(L_NAV,KC_R), COMBO_END}; // TYPE "there" #7 + 's
...
const uint16_t PROGMEM H_were_combo[] = {KC_W, KC_X, COMBO_END}; // TYPE "we're"
...
const uint16_t PROGMEM H_youre_combo[] = {KC_Y, KC_X, COMBO_END}; // TYPE "you're"
const uint16_t PROGMEM H_youve_combo[] = {KC_Y, KC_V, COMBO_END}; // TYPE "you've"
const uint16_t PROGMEM H_your_combo[] = {KC_Y, LT(L_NAV,KC_R), COMBO_END}; // TYPE "your"
const uint16_t PROGMEM H_their_combo[] = {LSFT_T(KC_T), LT(L_NAV,KC_R), COMBO_END}; // TYPE "their" #6
...
const uint16_t PROGMEM H_theyre_combo[] = {LSFT_T(KC_T), KC_X, COMBO_END}; // "they're"
...
//const uint16_t PROGMEM Htab_combo[] = {KC_J, KC_G, COMBO_END}; // tab
...
const uint16_t PROGMEM sya_combo[] = {LALT_T(KC_S), LGUI_T(KC_N), RSFT_T(KC_A), COMBO_END};  // しゃ
const uint16_t PROGMEM syu_combo[] = {LALT_T(KC_S), LGUI_T(KC_N), KC_U, COMBO_END};  //　しゅ
const uint16_t PROGMEM sye_combo[] = {LALT_T(KC_S), LGUI_T(KC_N), RGUI_T(KC_E), COMBO_END};  //　しぇ
const uint16_t PROGMEM syo_combo[] = {LALT_T(KC_S), LGUI_T(KC_N), KC_O, COMBO_END};  //　しょ
...
// Dead keys (Mac only, for now)
    ...
    [HC_OSLSH] = COMBO_ACTION(Hoslsh_combo), // ø/Ø
...
void process_combo_event(uint16_t combo_index, bool pressed) {
    ...
    if (pressed) {
        ...
        if (IS_ENGLISH_MODE
            ...
            && (combo_index >= jp_kya) && (combo_index <= jp_ryo)
#endif  // Japanese contracted sounds as combos
            )
            return;
#endif
        switch(combo_index) {

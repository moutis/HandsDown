...
//
#define HD_A LT(L_SYM,KC_A)
#define HD_B KC_B
#define HD_C RALT_T(KC_C)
#define HD_D LT(L_FUN,KC_D)
...
#define HD_COMM LT(L_NUM,KC_COMM)
...
//  Z   │  B   P   L   D   J  │ [ copy   pste ] │  -+   U   O   Y   F │ Q
//      ╰───────────╮ bsp  R  │ &             | │ spc  ret ╭──────────╯

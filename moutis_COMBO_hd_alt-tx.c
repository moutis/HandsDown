...
const uint16_t PROGMEM F_WIN_combo[] = {KC_HASH, KC_V, COMBO_END}; // Set WIN OS env var
const uint16_t PROGMEM F_SCLP_combo[] = {KC_MINS, KC_F, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_V, KC_M, KC_F, COMBO_END}; //  SCREEN shot SELECTION to file
...
// UPPER ROW
const uint16_t PROGMEM Hdquo_combo[] = {KC_DQUO, KC_QUOT, COMBO_END};  // "|" insert between double quote
const uint16_t PROGMEM Hdbrc_combo[] = {KC_LBRC, KC_RBRC, COMBO_END};  // [|] insert between double BRACKET
const uint16_t PROGMEM Hat_combo[] = {KC_HASH, KC_W, COMBO_END}; // @
...
const uint16_t PROGMEM Hgrv_combo[] = {KC_QUOT, KC_J, COMBO_END}; // ` grave
const uint16_t PROGMEM Hacut_combo[] = {KC_QUOT, KC_K, COMBO_END}; // ´ acute (dead key)
const uint16_t PROGMEM Hdier_combo[] = {KC_U, KC_J, COMBO_END}; // ¨ dieresis (dead key)
const uint16_t PROGMEM Hmacr_combo[] = {KC_DQUO, KC_J, COMBO_END}; // - macron (dead key)ā
const uint16_t PROGMEM Hcirc_combo[] = {KC_DQUO, KC_K, COMBO_END}; // ˆ circumflex (dead key)

// LOWER ROW
// SYMBOLS spatially arranged

const uint16_t PROGMEM Hbsls_combo[] = {KC_HASH, KC_SLSH, COMBO_END}; // \ backslash
...
const uint16_t PROGMEM Hexlm_combo[] = {KC_SLSH, KC_W, COMBO_END}; // ! exclamation
const uint16_t PROGMEM Hunds_combo[] = {KC_W, KC_COMM, COMBO_END}; // _ underscore
const uint16_t PROGMEM Helip_combo[] = {KC_SLSH, KC_DOT, COMBO_END}; // … elipses
const uint16_t PROGMEM Htild_combo[] = {KC_HASH, KC_COMM, COMBO_END}; // ~ tilde (not the dead one)
const uint16_t PROGMEM Hequal_combo[] = {KC_HASH, KC_DOT, COMBO_END}; // = equal
...
const uint16_t PROGMEM Htab_combo[] = {KC_V, KC_F, COMBO_END}; // tab HANDS DOWN
...
const uint16_t PROGMEM H_MB_combo[] = {KC_M, KC_F, COMBO_END}; // TYPE "mb"
const uint16_t PROGMEM H_tion_combo[] = {KC_P, KC_Y, COMBO_END}; // TYPE "tion"
...
const uint16_t PROGMEM Hfind_combo[] = {KC_F, KC_P, COMBO_END}; // find
...
// HANDSDOWN
    ...
    [HC_TYPE_MB] = COMBO_ACTION(H_MB_combo),

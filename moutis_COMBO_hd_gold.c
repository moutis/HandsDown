...
const uint16_t PROGMEM F_KILL_combo[] = {KC_X, KC_V, COMBO_END}; // Force quit
...
const uint16_t PROGMEM F_SCAP_combo[] = {KC_J, KC_W, COMBO_END}; //  SCREEN shot SELECTION to file
const uint16_t PROGMEM F_CAPS_combo[] = {KC_C, KC_U, COMBO_END}; // CAPS LOCK other shift lock
...
const uint16_t PROGMEM Hequal_combo[] = {KC_Y, KC_V, COMBO_END}; // = equal
...
const uint16_t PROGMEM H_Q2_combo[] = {KC_V, KC_U, COMBO_END}; // TYPE "q"
...
// FUNCTIONS Spatially arranged
const uint16_t PROGMEM Hent_combo[] = {KC_C, KC_B, COMBO_END}; // ENTER
const uint16_t PROGMEM Hclose_combo[] = {KC_L, KC_B, COMBO_END}; // close
const uint16_t PROGMEM Hquit_combo[] = {KC_G, KC_B, COMBO_END}; // quit
const uint16_t PROGMEM Hfind_combo[] = {KC_F, KC_W, COMBO_END}; // find
const uint16_t PROGMEM Hsall_combo[] = {KC_X, KC_C, COMBO_END}; // select all
...
const uint16_t PROGMEM Hpste_combo[] = {KC_L, KC_C, COMBO_END}; // paste
const uint16_t PROGMEM Hpstm_combo[] = {KC_G, KC_C, COMBO_END}; // paste-match

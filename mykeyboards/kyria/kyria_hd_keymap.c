...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_HDALPHA] = LAYOUT(
        ____, HD_LT4, HD_LT3, HD_LT2, HD_LT1, HD_LT0,   HD_RT0, HD_RT1, HD_RT2, HD_RT3, HD_RT4, ____,
        ____, HD_LM4, HD_LM3, HD_LM2, HD_LM1, HD_LM0,   HD_RM0, HD_RM1, HD_RM2, HD_RM3, HD_RM4, ____,
        ____, HD_LB4, HD_LB3, HD_LB2, HD_LB1, HD_LB0, LT(L_MEDIA_KBD,KC_MUTE), LT(L_NUMPAD,KC_ESC), LT(L_NUMPAD,KC_ESC), LT(L_MEDIA_KBD,KC_MPLY), HD_RB0, HD_RB1, HD_RB2, HD_RB3, HD_RB4, ____,
        ____, ____, HD_LH2, HD_LH1, LT(L_NAV,KC_SPC), LT(L_PUNCT,KC_LNG1), HD_RH1, HD_RH2, ____, ____),
    [L_PUNCT] = LAYOUT(
        ____, KC_Z, KC_Q, RALT(KC_5), LALT(KC_7), LSA(KC_7), LALT(KC_4), KC_DLR, A(S(KC_2)), RALT(KC_3), LALT(KC_Y), ____,
        ____, KC_LT, KC_LBRC, KC_LPRN, KC_LCBR, RSA(KC_5), RALT(KC_1), RSFT_T(KC_PAST), RGUI_T(KC_PEQL), RALT_T(KC_PPLS), RCTL_T(KC_PSLS), ____,
        ____, KC_GT, KC_RBRC, KC_RPRN, KC_RCBR, LALT(KC_8), ____, ____, ____, ____, KC_UNDS, KC_PIPE, KC_AMPR, KC_CIRC, KC_PERC, ____,
        ____, KC_VOLD, SK_DELWDL, SK_DELWDR, KC_VOLU, LALT(KC_9), LSA(KC_8), LSA(KC_9), ____, ____),
	[L_FN_NUM] = LAYOUT(
        ...
        RGB_VAD, KC_F1, KC_F2, KC_F3, KC_F4, KC_INS, ____, ____, ____, ____, KC_COMM, KC_4, KC_5, KC_6, KC_EQL, RGB_HUD,
        ____, ____, KC_SCLN, TG(L_NUMPAD), ____, ____, KC_0, KC_DOT, ____, SK_ZOOMRST),
	[L_NUMPAD] = LAYOUT(
        ...
        RGB_VAD, KC_DEL, KC_END, KC_TAB, KC_PGDN, KC_SPC, TG(5), _no_, _no_, LALT(KC_MINS), KC_PCMM, KC_P1, KC_P2, KC_P3, KC_PEQL, RGB_HUD,
        ____, TG(L_NUMPAD), LT(L_FN_NUM,KC_BSPC), LT(L_NAV,KC_PENT), ____, KC_DEL, LT(L_PUNCT,KC_P0), LT(L_NAV,KC_PDOT), KC_C, SK_ZOOMRST),
	[L_NAV] = LAYOUT(
        ____, SK_QUIT, SK_CLOZ, SK_SCAP, SK_SCLP, SK_FAGN, SK_DOCBEG, KC_HOME, KC_UP, KC_PGUP, SK_PARAPRV, KC_NUM,
        KC_VOLU, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, SK_FIND, SK_WORDPRV, KC_LEFT, KC_DOWN, KC_RGHT, SK_WORDNXT, ____,

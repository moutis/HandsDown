...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(SK_COPY, KC_W, KC_G, KC_M, KC_P, KC_J, KC_HASH, KC_DOT, KC_SLSH, KC_QUOT, KC_DQUO, KC_LNG2, SK_PSTE, RCTL_T(KC_C), RALT_T(KC_S), RGUI_T(KC_N), RSFT_T(KC_T), LT(L_NUMPAD,KC_K), LT(L_FN_NUM,KC_COMM), RSFT_T(KC_A), RGUI_T(KC_E), RALT_T(KC_I), RCTL_T(KC_H), KC_LNG1, KC_AMPR, KC_X, KC_F, KC_L, KC_D, KC_V, LT(7,KC_MUTE), LT(5,KC_ESC), LT(5,KC_ESC), LT(7,KC_MPLY), KC_MINS, KC_U, KC_O, KC_Y, KC_B, KC_EQL, LT(6,KC_MUTE), KC_APP, LT(L_FN_NUM,KC_BSPC), LT(L_NAV,KC_R), LT(4,KC_LNG2), LT(4,KC_LNG1), LT(L_PUNCT,KC_SPC), LT(L_NAV,KC_ENT), LT(4,KC_TAB), LT(6,KC_MPLY)),
	[1] = LAYOUT(KC_TRNS, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_TRNS, KC_TRNS, RCTL_T(KC_A), RALT_T(KC_S), RGUI_T(KC_D), RSFT_T(KC_F), LT(L_NUMPAD,KC_G), LT(L_FN_NUM,KC_H), RSFT_T(KC_J), RGUI_T(KC_K), RALT_T(KC_L), RCTL_T(KC_SCLN), KC_TRNS, KC_TRNS, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LT(L_NAV,KC_SPC), LT(L_PUNCT,KC_LNG1), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

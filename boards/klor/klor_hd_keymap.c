...
/* The Saegewerk Keymap Key position names
 * ,-----------------------------------------------.                                  ,-----------------------------------------------.
...
#ifdef L_QWERTY
    [L_QWERTY] = LAYOUT_saegewerk(
    KC_Q,  KC_W,   KC_E,   KC_R,   KC_T,                                   KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,
    RCTL_T(KC_A), RALT_T(KC_S), RGUI_T(KC_D), RSFT_T(KC_F), LT(L_NUM,KC_G), LT(L_FUN,KC_H), RSFT_T(KC_J), RGUI_T(KC_K), RALT_T(KC_L), KC_LNG1,
    KC_Z, KC_X,    KC_C,   KC_V,   KC_B,   HD_LBA,              HD_RBA, KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH,
                   KC_APP, LT(L_FUN,KC_BSPC), LT(L_NAV,KC_DEL),         LT(L_SYM,KC_SPC), LT(L_NAV,KC_ENT), LT(L_FUN,KC_MPLY)),
#endif // L_QWERTY
    [L_HD] = LAYOUT_saegewerk(

...
const uint16_t PROGMEM H_Left_combo[] = {KC_B, KC_H, KC_G, COMBO_END}; // TYPE LeftComboTapE
const uint16_t PROGMEM H_Right_combo[] = {KC_DOT, KC_SLSH, KC_J, COMBO_END}; // some demonstrator macro placeholder

const uint16_t PROGMEM F_KILL_combo[] = {KC_DQUO, KC_HASH, COMBO_END}; // KILL = Force quit OR CTRL-ALT-DEL
const uint16_t PROGMEM F_SCLP_combo[] = {KC_X, KC_B, KC_H, COMBO_END}; // SCREEN shot SELECTION to clipboard
const uint16_t PROGMEM F_SCAP_combo[] = {KC_X, KC_B, KC_H, KC_G, COMBO_END}; //  SCREEN shot SELECTION to file
...
const uint16_t PROGMEM Hequal_combo[] = {KC_U, KC_W, COMBO_END}; // = equal
...
const uint16_t PROGMEM Hcoln_combo[] = {KC_DOT, KC_J, COMBO_END}; // : colon
...
const uint16_t PROGMEM Hhash_combo[] = {KC_G, KC_DQUO, COMBO_END}; // # HASH used for §
...
const uint16_t PROGMEM Henye_combo[] = {KC_B, KC_G, COMBO_END}; // ˜ enye (dead key) (ñ only?)
...
const uint16_t PROGMEM Hmacr2_combo[] = {RGUI_T(KC_E), RCTL_T(KC_R), COMBO_END}; // - macron (dead key)
const uint16_t PROGMEM Hring_combo[] = {RSFT_T(KC_A), RCTL_T(KC_H), COMBO_END}; // ˚ ring (dead key)
const uint16_t PROGMEM Hring2_combo[] = {RSFT_T(KC_A), RCTL_T(KC_R), COMBO_END}; // ˚ ring (dead key)
...
const uint16_t PROGMEM H_Z_combo[] = {KC_B, KC_H, COMBO_END}; // TYPE "z"
const uint16_t PROGMEM H_Q_combo[] = {KC_G, KC_B, COMBO_END}; // TYPE "q" (Qu & Linger deletes u)
...
const uint16_t PROGMEM H_Wh_combo[] = {KC_Y, KC_W, COMBO_END}; // TYPE "wh"
const uint16_t PROGMEM H_Ph_combo[] = {KC_F, KC_D, COMBO_END}; // TYPE "ph"
const uint16_t PROGMEM H_Gh_combo[] = {KC_H, KC_G, COMBO_END}; // TYPE "gh"
...
const uint16_t PROGMEM H_Icap_combo[] = {RALT_T(KC_I), RCTL_T(KC_M), COMBO_END}; // TYPE "I"
const uint16_t PROGMEM H_Icap2_combo[] = {RALT_T(KC_I), RCTL_T(KC_R), COMBO_END}; // TYPE "I"
...
const uint16_t PROGMEM H_Im_combo[] = {KC_H, RALT_T(KC_I), COMBO_END}; // TYPE "I'm "
...
const uint16_t PROGMEM H_here_combo[] = {KC_H, LT(L_NAV, KC_R), COMBO_END}; // TYPE "here" #5 + 's
...
const uint16_t PROGMEM H_were2_combo[] = {KC_W, RCTL_T(KC_R), COMBO_END}; // TYPE "we're"
...
const uint16_t PROGMEM H_youre2_combo[] = {KC_Y, RCTL_T(KC_R), COMBO_END}; // TYPE "you're"
...
const uint16_t PROGMEM H_theyre2_combo[] = {RSFT_T(KC_T), RCTL_T(KC_R), COMBO_END}; // "they're"
...
const uint16_t PROGMEM rya2_combo[] = {RCTL_T(KC_R), RSFT_T(KC_A), COMBO_END};  // りゃ
const uint16_t PROGMEM ryu2_combo[] = {RCTL_T(KC_R), KC_U, COMBO_END};  //　りゅ
const uint16_t PROGMEM ryo2_combo[] = {RCTL_T(KC_R), KC_O, COMBO_END};  //　りょ
...
combo_t key_combos[] = {
    ...
    [HC_HASH] = COMBO(Hhash_combo, KC_TILD), // # hijacked for (
...
//    [HC_Sc] = COMBO_ACTION(H_Sc_combo), // conflicts with home row tab
...
*/
    ...
    [FC_LANG2] = COMBO(H_EISUU_combo, KC_INT5), // eisuu (others)
    [FC_LANG1] = COMBO(H_KANA_combo, KC_INT4), // kana (others)
...
// Dead keys (Mac only, for now)
    ...
    [HC_MACR2] = COMBO_ACTION(Hmacr2_combo), // - macron
    [HC_DIER] = COMBO_ACTION(Hdier_combo), // ¨ dieresis
    [HC_RING] = COMBO_ACTION(Hring_combo), // ˚ ring
    [HC_RING2] = COMBO_ACTION(Hring2_combo), // ˚ ring
...
// PRONOUNS Fast entry 4-7gram PRONOUNS (an English quirk)
    ...
    [HC_were2_5gram] = COMBO_ACTION(H_were2_combo),// TYPE "we're"
    ...
    [HC_youre2_6gram] = COMBO_ACTION(H_youre2_combo),// TYPE "you're"
    ...
    [HC_theyd_6gram] = COMBO_ACTION(H_theyd_combo), // TYPE "they'd" #23
    [HC_theyll_7gram] = COMBO_ACTION(H_theyll_combo), // TYPE "they'll" #23
    [HC_theyre_7gram] = COMBO_ACTION(H_theyre_combo), // TYPE "they're"
    [HC_theyre2_7gram] = COMBO_ACTION(H_theyre2_combo), // TYPE "they're"
...
//    [jp_hya2] = COMBO_ACTION(hya2_combo),  // ひゃ
    [jp_hyu2] = COMBO_ACTION(hyu2_combo),  // ひゅ
    [jp_hyo2] = COMBO_ACTION(hyo2_combo),  // ひょ
...
//    [jp_byu] = COMBO_ACTION(byu_combo),  // びゅ // handled in the main section
    ...
    [jp_rya2] = COMBO_ACTION(rya2_combo),  // りゃ
    [jp_ryu2] = COMBO_ACTION(ryu2_combo),  // りゅ
    [jp_ryo2] = COMBO_ACTION(ryo2_combo),  // りょ
...
//                case HC_ELIP:
                ...
                case HC_Sh:
                case HC_Th: // if this H digragh combo is held, then send S/Tion instead
                    unregister_mods(MOD_MASK_SHIFT);  //
                    send_string("ion");
                    break;
// PRONOUN shenanigans

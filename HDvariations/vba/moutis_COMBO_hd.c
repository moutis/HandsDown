...
const uint16_t PROGMEM H_Left_combo[] = {KC_X, KC_M, KC_P, COMBO_END}; // TYPE LeftComboTapE
...
const uint16_t PROGMEM F_SCAP_combo[] = {KC_X, KC_M, KC_G, KC_J, COMBO_END}; //  SCREEN shot SELECTION to file
...
const uint16_t PROGMEM Henye_combo[] = {KC_X, KC_J, COMBO_END}; // ˜ enye (dead key) (ñ only?)
...
const uint16_t PROGMEM H_Z_combo[] = {KC_W, KC_X, COMBO_END}; // TYPE "z"
const uint16_t PROGMEM H_Q_combo[] = {KC_X, KC_G, COMBO_END}; // TYPE "q" (Qu & Linger deletes u)
...
const uint16_t PROGMEM H_Wh_combo[] = {KC_X, KC_M, COMBO_END}; // TYPE "wh"
...
const uint16_t PROGMEM H_were_combo[] = {KC_W, KC_QUOT, COMBO_END}; // TYPE "we're"
...
const uint16_t PROGMEM Hopen_combo[] = {KC_W, LT(L_NUMPAD, KC_K), COMBO_END}; // open
...
const uint16_t PROGMEM Hswrd_combo[] = {KC_P, KC_V, COMBO_END}; // select word
const uint16_t PROGMEM Hundo_combo[] = {KC_P, KC_F, COMBO_END}; // undo
const uint16_t PROGMEM Hcut_combo[] = {KC_P, KC_L, COMBO_END}; // cut
